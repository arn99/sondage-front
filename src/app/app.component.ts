...
export class AppComponent {
  ...
  private jwtHelper: JwtHelperService = new JwtHelperService;
    constructor(private primengConfig: PrimeNGConfig, private router: Router, private userService: UserDataService) {}
    ngOnInit() {
    ...
    let user: User = {username: 'tester', password: 'passer1234'};
